...
class MessageRequest(BaseModel):
    phone_number: str
    message: str = "Hello! I'm Mayank. This is a test message sent from Whatsapp API. Bye!"
    language_code: str = "en_US"

@app.post("/send-whatsapp-message")
async def send_whatsapp_message(message_request: MessageRequest):
    load_dotenv()
...
async def root():
    ...
    return {"status": "online", "timestamp": datetime.utcnow().isoformat(), "total_visits": len(recent_requests)}